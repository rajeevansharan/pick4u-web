...
const Hero = () => {
  return (
    <section className="px-4 md:px-8 py-10 max-w-7xl mx-auto">
      <div className="relative bg-[#f0f4f8] rounded-[2rem] overflow-hidden min-h-[500px] flex flex-col md:flex-row items-center px-8 md:px-16 pt-12 md:pt-0">
        ...
        {/* Hero Image */}
        <div className="relative flex-1 h-[400px] md:h-[600px] w-full mt-8 md:mt-0">
